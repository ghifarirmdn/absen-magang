...
@section('container')
    <h3 class="text-gray-700 text-3xl font-medium capitalize">Data Pegawai</h3>
    <br>
    <div class="w-full m-auto p-6 bg-white border border-gray-200 rounded-lg shadow">
        <form>
            ...
            <div class="flex justify-end">
                <a href="#"
                    class="bg-orange-400 text-white rounded-md p-2 w-20 text-center hover:bg-orange-500 mb-5">Submit</a>
            </div>
        </form>
    </div>
@endsection
