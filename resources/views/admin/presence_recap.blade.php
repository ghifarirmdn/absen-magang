...
@section('container')
    ...
    <div class="flex justify-between items-center mt-10">
        <form action="{{ route('filter_presence') }}" method="get">
            @csrf
            <div date-rangepicker class="flex items-center">
                ...
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-bold p-2 rounded-md mx-4">Filter</button>
            </div>
        </form>
                                ...
                                <td class="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900">
                                        <button data-modal-target="defaultModal" data-modal-toggle="defaultModal"
                                            class="text-blue-700 hover:text-blue-900 font-medium text-sm" type="button">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button data-modal-hide="defaultModal" type="button"
                                                            class="text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Tutup</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
