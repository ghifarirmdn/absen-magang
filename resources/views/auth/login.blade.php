...
@section('content')
    <div
        class="flex h-screen flex-col justify-center items-center md:h-screen lg:py-0 sm:flex sm:items-center md:flex md:items-center lg:flex lg:items-center xl:flex xl:items-center 2xl:flex 2xl:items-center">
        ...
        <div class="mt-10 bg-white rounded-xl p-5 w-3/4 sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 2xl:w-1/3">
                ...
                <div class="sm:flex sm:flex-col sm:gap-2">
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="email" required
                            ...
                            class="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6">
                    </div>
                </div>
